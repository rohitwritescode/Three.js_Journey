...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        const poleLightLeftMesh = gltf.scene.children.find(child => child.name === 'poleLightLeft')
        const poleLightRightMesh = gltf.scene.children.find(child => child.name === 'poleLightRight')
